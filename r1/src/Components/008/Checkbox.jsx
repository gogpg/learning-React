...
const checksData = {A: false, B: false, C: false, D: false};
...
function Checkbox() {
    ...
    const change = e => {
        ...
        setCb(c => ({...c, [v]: !c[v]})); //kai v == 'A' => A: !c.A, jeigu v == a (t.y == true), tada pazymejus jisai persivercia, pasidaro false arba atvirksciai. ! zenklas pervercia i kita puse, perraso.
    }
